...
if ( ! class_exists( 'Tribe__Events__Community__Main' ) ) {
	...
	class Tribe__Events__Community__Main {
		...
		public function getTemplateFile( $name ) {
			_deprecated_function( __METHOD__, '4.10.14', 'get_template' );
			$template_path = Tribe__Events__Templates::getTemplateHierarchy( 'TEC\Events_Community\Routes\Abstract_Route::get_template()' );
		...
		public function default_template_compatibility( $print_before_after_override = false ) {
			_deprecated_function( __METHOD__, '4.10.14', 'default_template_compatibility located within the corresponding Callback.' );
		...
		public static function editCallback( $tribe_id ) {
			...
			_deprecated_function( __METHOD__, '4.10.14', 'No replacement.' );
		...
		public function doVenueForm( $tribe_venue_id ) {
			_deprecated_function( __METHOD__, '4.10.14', 'TEC\Events_Community\Callbacks\Venue\Route_Edit::callback()' );
		...
		public function doOrganizerForm( $organizer_id ) {
			_deprecated_function( __METHOD__, '4.10.14', 'TEC\Events_Community\Callbacks\Organizer\Route_Edit::callback()' );
			$valid        = false;
		...
		public function doMyEvents( $page = null, $print_before_after_override = false, $shortcode = false ) {
			_deprecated_function( __METHOD__, '4.10.14', 'TEC\Events_Community\Callbacks\Event\Callback_Add_Edit::callback()' );
			$output = '';
